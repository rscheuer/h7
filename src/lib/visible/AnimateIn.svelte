...
<div class="w-full h-full" use:visibility={options} on:visibilitychange={handleChange}>
	<div
		class:end={visible}
		style="--y: {20 * dir.y}px; --blur: {blur
			? 20
			: 0}px; transition-duration:{duration}s; transition-delay:{delay}s;"
